### Task 2: Platform Fetchers

**Files:**
- Create: `packages/backend/src/services/platformFetchers.ts`

**Interfaces:**
- Consumes: platform handle strings
- Produces: `PlatformContestResult[]` — array of `{ platform, contestName, contestUrl, rank, score, rating, ratingChange, problemsSolved, totalProblems, participatedAt }`

- [ ] **Step 1: Create platformFetchers.ts with types**
...
- [ ] **Step 2: Implement Codeforces fetcher**
...
- [ ] **Step 3: Implement LeetCode fetcher**
...
- [ ] **Step 4: Implement CodeChef fetcher**
...
- [ ] **Step 5: Implement HackerRank fetcher**
...
- [ ] **Step 7: Add master fetch function and export**
...
```bash
git add packages/backend/src/services/platformFetchers.ts
git commit -m "feat: add platform fetchers for Codeforces, LeetCode, CodeChef, HackerRank, GFG"
```
