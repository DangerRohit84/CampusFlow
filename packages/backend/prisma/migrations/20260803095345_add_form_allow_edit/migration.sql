...
INSERT INTO "new_Form" ("collegeId", "createdAt", "creatorId", "description", "id", "status", "title", "updatedAt") SELECT "collegeId", "createdAt", "creatorId", "description", "id", "status", "title", "updatedAt" FROM "Form";
DROP TABLE "Form";
